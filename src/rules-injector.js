...
- Do not report completion unless \`completion.eligible\` is true. Report failures, warnings, release/live gates, and missing or stale evidence accurately.
- If diagnostics fail, create a repair plan with \`plan_repair\` or \`repair_diagnostic\`. Never call \`apply_repair_plan\` without explicit user approval and separate high-risk approval when required.
${END_MARKER}`;
